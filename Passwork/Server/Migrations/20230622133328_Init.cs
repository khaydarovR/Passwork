        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Safes_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Passwords_Safes_SafeId",
                        column: x => x.SafeId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ChangedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2023, 6, 22, 13, 33, 28, 231, DateTimeKind.Utc).AddTicks(1173)),
                    Title = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PasswordChange_AspNetUsers_AppUsreId",
                        column: x => x.AppUsreId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PasswordChange_Passwords_PasswordId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PasswordTags", x => new { x.PasswordId, x.TagId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PasswordTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordChange_AppUsreId",
                table: "PasswordChange",
                column: "AppUsreId");

            migrationBuilder.CreateIndex(
                name: "IX_PasswordChange_Id",
                table: "PasswordChange",
                column: "Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PasswordChange_PasswordId",
                table: "PasswordChange",
                column: "PasswordId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Passwords_SafeId",
                table: "Passwords",
                column: "SafeId");

            migrationBuilder.CreateIndex(
                name: "IX_PasswordTags_TagId",
                table: "PasswordTags",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_Safes_CompanyId",
                table: "Safes",
                column: "CompanyId");
